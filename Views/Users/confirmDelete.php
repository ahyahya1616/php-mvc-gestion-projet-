...
<body class="bg-gradient-to-br from-purple-100 to-indigo-300 min-h-screen p-10">
    ...
    <div class="container mx-auto max-w-2xl">
        ...
        <div class="bg-white shadow-lg rounded-lg p-8 border border-indigo-200 space-y-6">
            <p class="text-lg font-medium text-gray-700">Utilisateur : <?php echo htmlspecialchars($user->getName()); ?></p>
            <p class="text-sm text-gray-600">Email : <?php echo htmlspecialchars($user->getEmail()); ?></p>
            <p class="text-sm text-gray-600">Role : <?php echo htmlspecialchars($user->getRole()); ?></p>

            <div class="mt-6 flex justify-around">
                <!-- Bouton pour confirmer la suppression -->
                <form action="index.php?action=deleteUser&id=<?php echo $user->getId(); ?>" method="POST">
